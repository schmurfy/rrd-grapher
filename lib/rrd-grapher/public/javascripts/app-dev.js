  ...
  window.Graph = (function() {
    ...
    Graph.prototype._update_graph_common = function(first, data_array) {
      ...
      if (first) {
        ...
        $(this.get("container")).bind("plothover", __bind(function(event, pos, item) {
          return this.show_tooltip(event, pos, item);
        }, this));
        $(this.get("container")).bind("plotselected", __bind(function(event, ranges) {
